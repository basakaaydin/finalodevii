...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: 21080560, [Github Repo](https://github.com/basakaaydin/finalodevii)
...
library(here)
library(readr)
adult_data <- read_csv(here("C:/Users/basak/OneDrive/Masaüstü/Finalodevii/data/AnyConv.com__adult.data.csv"))
```
...
adult_data %>%
  select("Age", "race", "capital gain", "hours per week", "sex") %>% 
